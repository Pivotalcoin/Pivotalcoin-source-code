...
"""Verify that starting pivotalcoin with -h works as expected."""

from test_framework.test_framework import PivotalcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(PivotalcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pivotalcoin with -h for help text")
        ...
        self.log.info("Start pivotalcoin with -version for version information")
        ...
        self.log.info("Start pivotalcoind with -fakearg to make sure it does not start")
