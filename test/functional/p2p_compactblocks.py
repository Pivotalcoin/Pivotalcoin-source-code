...
# TestP2PConn: A peer we use to send messages to pivotalcoind, and store responses.
...
class CompactBlocksTest(PivotalcoinTestFramework):
    ...
    # This test actually causes pivotalcoind to (reasonably!) disconnect us, so do this last.
    ...
    # pivotalcoind's choice of nonce.
    ...
    # Test that pivotalcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for pivotalcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # pivotalcoind will not send blocktxn responses for blocks whose height is
