/* src/config/pivotalcoin-config.h.  Generated from pivotalcoin-config.h.in by configure.  */
/* src/config/pivotalcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PIVOTALCOIN_CONFIG_H

#define PIVOTALCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Pivotalcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Pivotalcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/pivotalcoin/pivotalcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Pivotalcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Pivotalcoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "pivotalcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://pivotalcoincore.org/"
