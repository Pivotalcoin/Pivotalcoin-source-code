...
#ifndef PIVOTALCOIN_TEST_SCRIPTNUM10_H
#define PIVOTALCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Pivotalcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // PIVOTALCOIN_TEST_BIGNUM_H
