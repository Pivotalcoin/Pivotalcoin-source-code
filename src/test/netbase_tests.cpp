...
{
    BOOST_CHECK(TestSplitHost("www.pivotalcoincore.org", "www.pivotalcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.pivotalcoincore.org]", "www.pivotalcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.pivotalcoincore.org:80", "www.pivotalcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.pivotalcoincore.org]:80", "www.pivotalcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:12642", "127.0.0.1", 12642));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:12642", "127.0.0.1", 12642));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:12642", "::ffff:127.0.0.1", 12642));
    BOOST_CHECK(TestSplitHost("[::]:12642", "::", 12642));
    BOOST_CHECK(TestSplitHost("::12642", "::12642", -1));
    BOOST_CHECK(TestSplitHost(":12642", "", 12642));
    BOOST_CHECK(TestSplitHost("[]:12642", "", 12642));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:12642", "127.0.0.1:12642"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:12642", "[::]:12642"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
