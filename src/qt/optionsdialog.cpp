    ...
    mapper(0)
{
    ...
    ui->pivotalcoinAtStartup->setToolTip(ui->pivotalcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->pivotalcoinAtStartup->setText(ui->pivotalcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openPivotalcoinConfButton->setToolTip(ui->openPivotalcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new PivotalcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->pivotalcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPivotalcoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openPivotalcoinConf())
