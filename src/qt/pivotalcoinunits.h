...
#ifndef PIVOTALCOIN_QT_PIVOTALCOINUNITS_H
#define PIVOTALCOIN_QT_PIVOTALCOINUNITS_H
...
/** Pivotalcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PivotalcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PivotalcoinUnits(QObject *parent);

    /** Pivotalcoin units.
      @note Source: https://en.pivotalcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        PVC,
...
typedef PivotalcoinUnits::Unit PivotalcoinUnit;

#endif // PIVOTALCOIN_QT_PIVOTALCOINUNITS_H
