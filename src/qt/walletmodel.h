...
#ifndef PIVOTALCOIN_QT_WALLETMODEL_H
#define PIVOTALCOIN_QT_WALLETMODEL_H
...
/** Interface to Pivotalcoin wallet from Qt view code. */
...
#endif // PIVOTALCOIN_QT_WALLETMODEL_H
