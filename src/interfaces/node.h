...
#ifndef PIVOTALCOIN_INTERFACES_NODE_H
#define PIVOTALCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a pivotalcoin node (pivotalcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // PIVOTALCOIN_INTERFACES_NODE_H
