...
#ifndef PIVOTALCOIN_WALLET_WALLET_H
#define PIVOTALCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this pivotalcoin node, and set to 0 for transactions that were created
...
#endif // PIVOTALCOIN_WALLET_WALLET_H
