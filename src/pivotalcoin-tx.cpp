...
static void SetupPivotalcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " pivotalcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  pivotalcoin-tx [options] <hex-tx> [commands]  Update hex-encoded pivotalcoin transaction\n" +
            "or:     pivotalcoin-tx [options] -create [commands]   Create hex-encoded pivotalcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pivotalcoin transaction
