...
* pivotalcoin.conf: contains configuration settings for pivotalcoind or pivotalcoin-qt
* pivotalcoind.pid: stores the process id of pivotalcoind while running
...
* debug.log: contains debug information and general logging generated by pivotalcoind or pivotalcoin-qt
