...
This document provides guidelines for internationalization of the Pivotalcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `pivotalcoin_en.ts` remains unchanged.
